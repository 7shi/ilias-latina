...
make greek          # put the Greek lines beside the verses (tmp/greek.md)
```
...
| `greek` | `greek.md` — the verses of The Latin Library in sections, with the Greek lines they render | `greek.py` |
